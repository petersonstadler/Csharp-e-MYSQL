...
namespace Csharp_e_MYSQL.Classes
{
    public class Produto
    {
        ...
        public DataTable ListarProdutos()
        {
            ...
            return db.FillDataTable("SELECT idprod as Id, nomeprod as Nome, codprod as Codigo, custoprod as Custo, vendaprod as Venda FROM produto;", "Listar Produtos");
        }

        public DataTable BuscarProdutoPorId(int idbusca)
        {
            DatabaseConnection db = new DatabaseConnection();
            return db.FillDataTable($"SELECT idprod as Id, nomeprod as Nome, codprod as Codigo, custoprod as Custo, vendaprod as Venda FROM produto WHERE idprod = {idbusca};", "Buscar Produto");
        }

        public DataTable BuscarProdutoPorNome(string busca)
        {
            DatabaseConnection db = new DatabaseConnection();
